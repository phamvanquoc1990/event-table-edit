...
class EventtableeditViewEtetable extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		if ($this->print) {
			...
			$this->document->addScript($this->baseurl.'/components/com_eventtableedit/template/js/tablesaw.js?v2');
			...
			$this->document->addScript($this->baseurl.'/components/com_eventtableedit/helpers/popup.js?v2');
